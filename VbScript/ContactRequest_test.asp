...
dim rc2 : rc2 = 0
dim rc3 : rc3 = 0
dim anfrage, strValid, i, j, tmpChar, ok, abort, invalidPhone
...
if UCase(Request.ServerVariables("REQUEST_METHOD")) = "POST" then
	...
	If abort = false Then
		...
		message = "Anfrage via Campingboerse betreffend: " & Request("Modell_Titel") &_
				", id=" & Request("eintrag_id") & "" & vbcrlf &_
													vbcrlf &_
	...
	Else ' abort = true
		if invalidPhone then
			trace "One of the phone number fields contained invalid characters - not sending mail"
		else
					...
					<td width="100%">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="90%" align="left">
										<a href="Start.asp?<%=urlParams%>">Campingbörse</a> | <a href="Filter.asp?<%=urlParams%>">
											Reisemobilsuche</a> | <a href="Liste.asp?<%=urlParams%>">Liste</a> | <a href="Details.asp?<%=urlParams%>">
												Details</a> | Kontaktaufnahme
									</td>
						...
						<center>
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="90%" align="left">
										<a href="Start.asp">Campingbörse</a> | <a href="Filter.asp?<%=urlParams%>">Wohnwagensuche</a>
										| <a href="Liste.asp?<%=urlParams%>">Liste</a> | <a href="Details.asp?<%=urlParams%>">
											Details</a> | Kontaktaufnahme
									</td>
									<td width="10%" align="right">
									</td>
						...
						<center>
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="90%" align="left">
										<a href="Start.asp?<%=urlParams%>">Campingbörse</a> | <a href="Filter.asp?<%=urlParams%>">
											Klappzeltanhägersuche</a> | <a href="Liste.asp?<%=urlParams%>">Liste</a> | <a href="Details.asp?<%=urlParams%>">
												Details</a> | Kontaktaufnahme
									</td>
									<td width="10%" align="right">
									</td>
						...
						<center>
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="90%" align="left">
										<a href="Start.asp?<%=urlParams%>">Campingbörse</a> | <a href="Filter.asp?<%=urlParams%>">
											Zubehörsuche</a> | <a href="Liste.asp?<%=urlParams%>">Liste</a> | <a href="Details.asp?<%=urlParams%>">
												Details</a> | Kontaktaufnahme
									</td>
									<td width="10%" align="right">
									</td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td width="100%" colspan="2">
									<img border="0" src="../UserManagement/images/1x1.gif" width="10" height="20">
								</td>
							</tr>
						</table>
						<!--webbot bot="Include" i-checksum="50745" endspan -->
						<p>
							<b><font color="#FF0000">
								<%=ErrMsg%><%=infoMsg%></font></b></p>
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td width="100%">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											<td width="90%">
												© <a href="http://www.campsite.at" target="_blank">Campingfuehrer.at</a> &amp; <a
													target="_blank" href="http://www.camping.info">camping.info</a>&nbsp;-&nbsp;<a href="Impressum.asp"
														target="_blank">Impressum</a> - Alle Rechte vorbehalten. Alle Angaben ohne Gewähr.<%if not gTrader_ContentSharing then%>&nbsp;<a
															href="nutzungsbedingungen.asp" target="_blank">Nutzungsbedingungen</a>.<%end if%>
											</td>
											<td width="10%" align="right">
												<a href="#top">
													<img border="0" src="../images/Misc/top_grey.gif" width="24" height="24"></a>
											</td>
										</tr>
										<tr>
											<td width="100%" colspan="2">
												<img border="0" src="../UserManagement/images/1x1.gif" width="10" height="5">
											</td>
										</tr>
									</table>
									<!--webbot bot="Include" i-checksum="2526" endspan -->
								</td>
							</tr>
						</table>
					</td>
